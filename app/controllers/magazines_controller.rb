class MagazinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @magazine.save
        format.html { redirect_to magazines_path, notice: 'Magazine was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @magazine.update(magazine_params)
        format.html { redirect_to magazines_path, notice: 'Magazine was successfully updated.' }
